...
SYSTEM_PROMPT = """
    ...
    - User is on Windows using VS Code.
    - Use Windows CMD / PowerShell commands only.
    - Do not use Linux commands like touch, ls, rm, cat <<EOF.
    ...
    -run_command(cmd: str): Executes Windows CMD / PowerShell command on user system and returns output.
